  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/gatos" element={<Layout><GatoList /></Layout>} />
        <Route path="/cachorros" element={<Layout><CachorroList /></Layout>} />
        <Route path="/roedores" element={<Layout><RoedoresList /></Layout>} />
        <Route path="/peixes" element={<Layout><PeixesList /></Layout>} />
        ...
        <Route path="/conta" element={<Layout><Conta /></Layout>} />
      </Routes>
    </BrowserRouter>
  );
}
