            ...
            <div className="row justify-content-xl-end">
              <div className="col-12 col-xl-11">
                ...
                <p className="lead fs-4 text-secondary mb-5">
                  Esperamos que você consiga achar uma resposta para sua dúvida.
                  Se você precisar de ajuda, entre em contato via e-mail ou
                  preencha o fórmulário dessa página.
                </p>
                <div
                ...
                >
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        item desejado. Em seguida, clique em "Comprar" e siga as
                        instruções para finalizar a compra.
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        localidade de entrega. Em geral, o prazo é de 5 a 7 dias
                        úteis.
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Sim, é possível trocar ou devolver um produto dentro do
                        prazo de 7 dias após a entrega. Entre em contato conosco
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          Para cancelar uma compra certifique-se que sua compra
                          foi realizada em um período de 24h. Depois, siga essas
                          instruções:
                        </p>
                        <ul>
